...
clean: clean-build clean-pyc clean-test clean-docs clean-data clean-rej ## Remove all build, test, coverage, artifacts and empty data/out
...
clean-rej: ## Remove *.rej files generated by cruft
